...
<Card title="Fields for Norm Aasta Sds / Yearly Cluster Object" icon="link" href="/database/tables/norm_aasta_sds_uus">Show the fields associated with the object.</Card>
<CardGroup cols={2}>
