...
The YearlyCluster class is a serializable entity representing financial metrics for a given year. It includes methods for performing operations such as division, subtraction, clamping values to specified limits, and converting the object to an array of values.
